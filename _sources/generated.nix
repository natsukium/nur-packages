...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  vivaldi-darwin = {
    ...
    version = "7.1.3570.60";
    src = fetchurl {
      url = "https://downloads.vivaldi.com/stable/Vivaldi.7.1.3570.60.universal.dmg";
      sha256 = "sha256-7vuBka7tFpf/A4KQrOoqHOM2N8Rx4K02yHmY9tv4F1I=";
    };
  };
  zen-browser = {
    pname = "zen-browser";
    version = "1.9.1b";
    src = fetchurl {
      url = "https://github.com/zen-browser/desktop/releases/download/1.9.1b/zen.macos-universal.dmg";
      sha256 = "sha256-h3dnRzjJ0rfrg8b5K8UsdR8bScPIZ/V3jviirkWb+gU=";
    };
  };
}
